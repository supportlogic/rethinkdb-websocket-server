...
var Connection = (function () {
  function Connection(queryValidator, webSocket, loggingMode, httpInfoMsg) {
  ...
  _createClass(Connection, [{
    ...
    value: function start(_ref) {
      ...
      var urlQueryParams = _url2['default'].parse(this.httpInfoMsg.url, true).query;
      var req = this.httpInfoMsg;
